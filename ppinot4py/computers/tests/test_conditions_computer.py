...
def test_time_instant_process_start_activity():
        ...
        result_expected = [True, False, False, True, False]

        assert (result.values == result_expected).all()


def test_time_instant_process_end_activity():
...
def test_time_instant_process_custom_activity():
